...
\fbox{
	...
	{					
		...
		\end{tikzpicture}
		\textcolor{blue}{g} tirtt erneut auf obwohl \textcolor{blue}{g} noch nicht fertig abgearbeitet ist.
...
\paragraph{3. Aufstellen:} hdh\\
\paragraph{4. Überprüfung der RT-Bedingung:}asd\\
