...
\subsection{Zentrale Beschreibgrößen (Wiederholung)}
...
\fbox{
	...
	{	
		...
		\begin{description}
			...
			\item - \textcolor{blue}{\(t_{Ph,i}\)} = Phase, zeitlicher Abstand zwischen zwei \textcolor{red}{unterschiedlicher} Ereignisse
		\end{description}
	}
}
